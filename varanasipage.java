...
public class varanasipage {
    private JPanel panel;
    private static final Color ACCENT_COLOR = new Color(228, 130, 62);  // Varanasi Orange/Saffron

    public varanasipage() {
        // Professional background panel with enhanced parallax
        panel = new JPanel() {
            Image backgroundImage = new ImageIcon("C:\\Users\\Kush\\Desktop\\NewPJ\\v1.jpg").getImage();
            int offsetY = 0;
            Timer parallaxTimer;
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(
                        0, 0, new Color(45, 25, 15, 185),
                        0, getHeight(), new Color(35, 15, 5, 195)
                );
        ...
        cardsPanel.add(frontend.SimpleWeatherUtil.createWeatherCard("varanasi", "#e4823e"));
        cardsPanel.add(frontend.TransportationUtil.createTransportationCard("varanasi", "#e4823e"));
        cardsPanel.add(frontend.LocalAttractionsUtil.createAttractionsCard("varanasi", "#e4823e"));
