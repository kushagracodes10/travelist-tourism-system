...
public class jaipurpage {
    private JPanel panel;
    private static final Color ACCENT_COLOR = new Color(240, 171, 81);  // Jaipur Gold/Amber

    public jaipurpage() {
        // Professional background panel with enhanced parallax
        panel = new JPanel() {
            Image backgroundImage = new ImageIcon("C:\\Users\\Kush\\Desktop\\NewPJ\\j1.jpg").getImage();
            int offsetY = 0;
            Timer parallaxTimer;
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(
                        0, 0, new Color(50, 25, 5, 185),
                        0, getHeight(), new Color(45, 20, 0, 195)
                );
        ...
        titlePanel.add(Box.createVerticalStrut(20));  // Unchanged
        ...
        cardsPanel.add(frontend.SimpleWeatherUtil.createWeatherCard("jaipur", "#f0ab51"));
        cardsPanel.add(frontend.TransportationUtil.createTransportationCard("jaipur", "#f0ab51"));
        cardsPanel.add(frontend.LocalAttractionsUtil.createAttractionsCard("jaipur", "#f0ab51"));
